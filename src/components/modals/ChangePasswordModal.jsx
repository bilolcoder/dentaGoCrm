                    ...
                    <div className="relative">
                        ...
                        <div className="relative">
                            <input
                                ...
                                placeholder="********"
                                className="w-full px-4 py-2 bg-white border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#00BCE4] outline-none text-[#00BCE4] transition-all pr-10"
                            />
                            <button
                                type="button"
